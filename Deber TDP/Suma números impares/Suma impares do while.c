...
int main() { // Función principal del programa
    ...
    int i = 1; // Inicializamos la variable i en 1 para utilizarlo como contador en el bucle do-while
    ...
    } while (i <= n); // Continuamos iterando mientras el contador i sea menor o igual a n
